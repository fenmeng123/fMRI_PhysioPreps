...
%       T_ParsedHeaders - a table contains headers and the appened trace
%                           data, which could be generated by 
%                           's_parse_siemens_ECG_Extract_Headers'.
% Output:
%   FullTraceDat - a vector contains the concatenated trace data across the
%                   ECG file.
%   T_ECG_Channels - a table contains four ECG channels data, indicated by
%                       columns 'Channel_1', 'Channel_2', 'Channel_3', and
%                       'Channel_4'.
%   T_ECG_SignalIndex - a table contains the string location index for each
%                       value in each channel, indicated by columns 
%                       'IdxCH1', 'IdxCH2', 'IdxCH3', and 'IdxCH4', where
%                       values reflect the location of this data point in
%                       the raw string from the 'first line data'.
% 
% Written By Kunru Song 2023.11.16
